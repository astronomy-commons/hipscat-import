...
class SoapArguments(RuntimeArguments):
    ...
    def _check_arguments(self):
        ...
        if self.object_id_column in ["primary_id", "join_id"]:
            raise ValueError("object_id_column uses a reserved column name")
        ...
        if self.source_object_id_column in ["primary_id", "join_id"]:
            raise ValueError("source_object_id_column uses a reserved column name")
