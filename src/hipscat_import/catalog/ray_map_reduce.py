...
def split_pixels(
    ...
    for input_file, shard_suffix in vals:
...
def reduce_pixel_shards(
    ...
    vals = zip(
        df['destination_pixel_order'],
        df["destination_pixel_number"],
        df["destination_pixel_size"]
    )
    for destination_pixel_order, destination_pixel_number, destination_pixel_size in vals:
